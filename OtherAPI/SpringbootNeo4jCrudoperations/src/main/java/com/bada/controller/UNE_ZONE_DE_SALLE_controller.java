...
public class UNE_ZONE_DE_SALLE_controller {
    ...
    public UNE_ZONE_DE_SALLE getById(@PathVariable(value= "UNE_ZONE_DE_SALLE-Id") String Id) {
        logger.debug("Getting UNE_ZONE_DE_SALLE with UNE_ZONE_DE_SALLE-Id= {}.", Id);
       // return serv.findUNE_ZONE_DE_SALLEById(Id);
        return mongoTemplate.findOne(new Query(where("CODE").is(Id)), UNE_ZONE_DE_SALLE.class);
